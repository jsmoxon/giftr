...
urlpatterns = patterns('',
    ...
    url(r'^ideas/(?P<gift_id>\d+)/$', views.ideas_page, name='ideas_page'),
    url(r'^confirm/(?P<gift_id>\d+)/(?P<gift_option_id>\d+)/$', views.occasion_gift_confirmation_page, name='confirm_gift'),
    url(r'^confirmation/(?P<gift_id>\d+)/$', views.purchase_confirmation_page, name='purchase_confirmation_page'),
